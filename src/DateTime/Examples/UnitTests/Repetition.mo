...
package Repetition
  ...
  algorithm
    when initial() then
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "hourly", cet, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "daily", pst, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "weekly", pst, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "monthly", pst, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "yearly", pst, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "workdays", cet, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "firstDayInMonth", cet, workdays, holidays, false, true, "time_from_day_start");
      ...
      result := Functions.addSingleRepetitionToDatetime(dt, "lastDayInMonth", cet, workdays, holidays, false, true, "time_from_day_start");
  ...
  algorithm
    when initial() then
      ...
      (prevTrigger, prevTriggerPosix) := Functions.largestPreviousTrigger(simPosixTime, initTrigger, "workdays", cet, workdays, holidays, false, true, "time_from_day_start");
