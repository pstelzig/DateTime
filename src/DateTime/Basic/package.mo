...
package Basic "Library of basic blocks to handle absolute times, timezones, calendrical events, schedules and more. Copyright <html>&copy;</html> Dr. Philipp Emanuel Stelzig, 2019-present. ALL RIGHTS RESERVED."
